...
export const T = {
  fr: {
    ...
    /* ── E-paiement ── */
    epDashboard: "Tableau de bord EP",
    liquidations: "Liquidations",
    listePaiements: "Liste des paiements",
    generationXML: "Génération fichier banque",
    natureRemise: "Nature de remise",
    baliseXML: "Balise XML",
    mappageXML: "Mappage XML — Banques",
    parametrageEP: "Paramétrage",
    ...
    /* ── Fournisseur landing ── */
    portailTitle: "Espace collaboratif",
    ...
    /* ── Portail client — textes hero & badges ── */
    sslBadge: "Espace sécurisé SSL",
    plateformeActive: "Plateforme active",
    heroTitle1: "Votre espace",
    heroTitle2: "fournisseur",
    heroDesc: "Déposez, suivez et gérez vos documents en toute sécurité. Accédez au tableau de bord complet via votre compte interne.",
    deposeDescLong: "Créez un compte et soumettez vos factures, bons de livraison et contrats avec extraction OCR automatique.",
    suiviDescLong: "Consultez en temps réel le statut de traitement de vos documents soumis et l'avancement des validations.",
    backofficeDescLong: "Accédez au tableau de bord complet SoftDocs avec votre compte utilisateur interne.",
    badgeSSL: "Transmission SSL chiffrée",
    badgeOCR: "OCR automatique",
    badgeSuivi: "Suivi en temps réel",
    badgeRGPD: "Conformité RGPD",
    badgeArchivage: "Archivage numérique",
    footerCopy: "© 2025 SoftDocs — Système de Gestion Électronique de Documents · Madagascar",
    portailSub: "Portail Fournisseurs",

    /* ── Portail client — formulaire fournisseur ── */
    loginTab: "Se connecter",
    registerTab: "Créer un compte",
    fieldNIF: "NIF (Numéro d'Identification Fiscal)",
    fieldNIFPlaceholder: "Ex: 1234567890",
    fieldSTAT: "STAT (Numéro Statistique)",
    fieldSTATHint: "Numéro statistique à 17 caractères",
    fieldNom: "Raison sociale / Nom",
    fieldMail: "Adresse email professionnelle",
    fieldPhone: "Téléphone",
    fieldAdresse: "Adresse ligne 1",
    fieldVille: "Ville",
    fieldPays: "Pays",
    fieldPassword: "Mot de passe",
    fieldConfirmPassword: "Confirmer le mot de passe",
    errNIF: "NIF invalide — exactement 10 chiffres",
    errSTAT: "STAT invalide — exactement 17 caractères",
    errMail: "Adresse email invalide",
    errPhone: "Numéro de téléphone invalide",
    errNom: "Raison sociale obligatoire (min. 3 caractères)",
    errNIFReq: "NIF obligatoire",
    errSTATReq: "STAT obligatoire",
    errLoginFail: "NIF/STAT incorrect ou compte introuvable",
    btnCreerCompte: "Créer mon compte",
    btnSeConnecter: "Se connecter",
    ocrSteps: ["Détection du format document…","Reconnaissance des zones de texte…","Extraction du numéro de document…","Lecture des montants HT / TVA / TTC…","Vérification du NIF fournisseur…","Validation IBAN (algorithme Luhn)…","Calcul du score de confiance OCR…","Contrôle anti-doublon en cours…"],
    ...
    relanceMenu: "Relance",
    relanceTitle: "Modèle de relance",
    relanceDesc: "Configurez le modèle d'email de relance automatique pour les validations en retard.",
    relanceObjet: "Objet du mail",
    relanceCC: "En copie (CC)",
    relanceMsg: "Corps du message",
    relanceSave: "Enregistrer le modèle",
    relanceSaved: "Modèle enregistré !",
    relancerBtn: "Relancer",
    relanceEnvoye: "Mail de relance envoyé !",
    relanceAutoInfo: "Le premier mail de relance automatique sera envoyé à la date de fin de l'échéance.",
    relanceTraitementRetard: "Relance traitement en retard",
    relanceTraitementRetardDesc: "Peut envoyer des relances pour les documents en retard",
    droitRelance: "relance",
  ...
  en: {
    ...
    /* ── E-paiement ── */
    epDashboard: "EP Dashboard",
    listePaiements: "Payment List",
    generationXML: "Generate Bank File",
    natureRemise: "Remittance Type",
    baliseXML: "XML Tags",
    mappageXML: "XML — Bank Mapping",
    parametrageEP: "EP Settings",
    ...
    /* ── Depot form fields ── */
    etape2: "2. Information",
    etape3: "3. Attachments",
    etape4: "4. Confirmation",
    categorie: "Category",
    date: "Date",
    projet: "Project",
    site: "Site",
    montantReel: "Actual amount (if correction)",
    ...
    /* ── Fournisseur landing ── */
    portailTitle: "Collaborative workspace",
    ...
    /* ── Supplier portal — hero & badges ── */
    sslBadge: "Secure SSL space",
    plateformeActive: "Active platform",
    heroTitle1: "Your supplier",
    heroTitle2: "workspace",
    heroDesc: "Upload, track and manage your documents securely. Access the full dashboard with your internal account.",
    deposeDescLong: "Create an account and submit your invoices, delivery notes and contracts with automatic OCR extraction.",
    suiviDescLong: "Check the real-time processing status of your submitted documents and the progress of validations.",
    backofficeDescLong: "Access the full SoftDocs dashboard with your internal user account.",
    badgeSSL: "SSL encrypted transmission",
    badgeOCR: "Automatic OCR",
    badgeSuivi: "Real-time tracking",
    badgeRGPD: "GDPR compliant",
    badgeArchivage: "Digital archiving",
    footerCopy: "© 2025 SoftDocs — Electronic Document Management System · Madagascar",
    portailSub: "Supplier Portal",

    /* ── Supplier portal — form ── */
    loginTab: "Sign in",
    registerTab: "Create account",
    fieldNIF: "NIF (Tax Identification Number)",
    fieldNIFPlaceholder: "E.g.: 1234567890",
    fieldSTAT: "STAT (Statistical Number)",
    fieldSTATHint: "17-character statistical number",
    fieldNom: "Company name",
    fieldMail: "Professional email address",
    fieldPhone: "Phone number",
    fieldAdresse: "Address line 1",
    fieldVille: "City",
    fieldPays: "Country",
    fieldPassword: "Password",
    fieldConfirmPassword: "Confirm password",
    errNIF: "Invalid NIF — exactly 10 digits",
    errSTAT: "Invalid STAT — exactly 17 characters",
    errMail: "Invalid email address",
    errPhone: "Invalid phone number",
    errNom: "Company name required (min. 3 characters)",
    errNIFReq: "NIF required",
    errSTATReq: "STAT required",
    errLoginFail: "Incorrect NIF/STAT or account not found",
    btnCreerCompte: "Create my account",
    btnSeConnecter: "Sign in",
    ocrSteps: ["Detecting document format…","Recognizing text zones…","Extracting document number…","Reading amounts HT / VAT / TTC…","Verifying supplier NIF…","IBAN validation (Luhn algorithm)…","Calculating OCR confidence score…","Duplicate check in progress…"],
    ...
    relanceMenu: "Follow-up",
    relanceTitle: "Follow-up email template",
    relanceDesc: "Configure the automatic follow-up email template for overdue validations.",
    relanceObjet: "Subject",
    relanceCC: "CC",
    relanceMsg: "Message body",
    relanceSave: "Save template",
    relanceSaved: "Template saved!",
    relancerBtn: "Follow up",
    relanceEnvoye: "Follow-up email sent!",
    relanceAutoInfo: "The first automatic follow-up will be sent on the deadline date.",
    relanceTraitementRetard: "Overdue processing follow-up",
    relanceTraitementRetardDesc: "Can send follow-ups for overdue documents",
    droitRelance: "relance",
