...
export function SidebarEP(){
  ...
  return(
    <div style={{width:240,background:"linear-gradient(180deg,"+GDk+" 0%,"+GBr+" 100%)",display:"flex",flexDirection:"column",flexShrink:0,borderRight:"1px solid rgba(255,255,255,.08)"}}>
      {/* Brand */}
      <div style={{padding:"14px 16px",borderBottom:"1px solid rgba(255,255,255,.08)",display:"flex",alignItems:"center",gap:10}}>
        ...
        <button onClick={()=>setSidebarOpen(false)} title="Réduire" style={{width:24,height:24,borderRadius:4,background:"transparent",border:"none",cursor:"pointer",color:MUT_C,display:"flex",alignItems:"center",justifyContent:"center",flexShrink:0}}>
