      ...
      <div style={{width:"100%",maxWidth:420,padding:"0 20px",position:"relative",zIndex:10}}>
        ...
        <div style={{textAlign:"center",marginBottom:28}}>
          {/* Temporary logo - replace with your logo */}
                    <img src="/softappli-logo.png" alt="SoftAppli" style={{height:72,objectFit:"contain",margin:"0 auto 14px",display:"block",filter:"drop-shadow(0 4px 16px rgba(30,58,138,.2))"}}/>
        ...
        <form onSubmit={handleLogin} style={{background:"#fff",borderRadius:16,padding:"28px 32px",boxShadow:"0 24px 60px rgba(0,0,0,.35)"}}>
